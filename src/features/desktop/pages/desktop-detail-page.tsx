...
import { Button, Dropdown, Empty, Spin, Tag, Tooltip } from '@/shared/ui';
import { useMessageFormatter } from '@/utils/message-format';
import { useLocation, useNavigate } from 'react-router';
import Close from '@/features/desktop/components/detail-close-icon';
import Open from '@/features/desktop/components/detail-open-icon';
...
import { transStatus } from '../model/use-desk-hooks';
import useDeskDetail from '../model/use-desk-detail';
import useSnap from '../model/use-snap';
import './desktop-detail-page.scss';

const AllDiskListModal = lazy(() => import('../components/all-disk-list-modal'));
const CreateModal = lazy(() => import('../components/create-snapshot-modal'));
