...
import { Button, Empty, Popover, Select, Space, Table, Tag, Tooltip } from '@/shared/ui/fast';
import type { ColumnsType, SelectProps, TablePaginationConfig } from '@/shared/ui/fast';
