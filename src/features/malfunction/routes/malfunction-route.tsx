...
import './malfunction-route.scss';
import { initQueryParams, useFaultStatus, useFaultType } from '../model/init-data';
import { MalfunctionPage } from '../pages/malfunction-page';
import type { ViewFaultStatus, ViewFaultType } from '../model/types';

const CreatedModal = lazy(() => import('../components/create-fault-modal'));
