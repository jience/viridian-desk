...
const AddFromSysModal = lazy(() =>
  import('../components/add-from-sys-modal').then((module) => ({
    default: module.AddFromSysModal,
  })),
);
const AddFromSelfModal = lazy(() =>
  import('../components/add-from-self-modal').then((module) => ({
    default: module.AddFromSelfModal,
  })),
);
