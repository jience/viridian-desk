...
import type { ItemType } from '@/shared/ui/fast';
import type { ModalFunc } from '@/shared/ui/fast';
...
import type { DefaultOptionType } from '@/shared/ui/fast';
import './application-page.scss';

const AppDetailModal = lazy(() =>
  import('../components/app-detail-modal').then((module) => ({ default: module.AppDetailModal })),
);
